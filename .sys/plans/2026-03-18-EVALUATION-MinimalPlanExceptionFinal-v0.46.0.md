...
- **Impact**: Unblocks the execution pipeline by bumping the domain version to v0.46.0.

#### 2. File Inventory
- **Create**: `.sys/plans/2026-03-18-EVALUATION-MinimalPlanExceptionFinal-v0.46.0.md`
...
- **Pseudo-Code**:
  ...
  - Update domain tracking files for v0.46.0.
- **Baseline and Regression Flow**: N/A
- **Dependencies**: CONTRACTS schemas exist, RUNTIME resolver exists.

#### 4. Test Plan
- **Verification**: `cat .sys/plans/2026-03-18-EVALUATION-MinimalPlanExceptionFinal-v0.46.0.md`
