...
- **Trigger**: `docs/status/EVALUATION.md` indicates `v0.36.0` is complete, and no further gaps exist in the current vision document.
- **Impact**: Satisfies the system's planning requirement without introducing unneeded features or violating scope.

#### 2. File Inventory
- **Create**: `.sys/plans/2026-04-14-EVALUATION-MinimalPlanExceptionFinal-v0.37.0.md`
