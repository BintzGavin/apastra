...
- `promptops/policies/flake-quarantine.md`
- `promptops/policies/holdout-sets.md`
- `promptops/policies/approachable-terminology.md`
...
- `promptops/policies/appeals.md`: Moderation Decision Appeals Policy. Describes the formal, append-only process for appealing takedown decisions using takedown-appeal-record.schema.json.
...
- `promptops/policies/project-level-config.md`: Governance rules for project-level configurations and minimal file structure auto-activation.
