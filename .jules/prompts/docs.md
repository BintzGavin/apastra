...
**Responsibility**: You are the Documentation Maintainer. You perform a comprehensive daily review and update of all user-facing and agent-facing documentation, ensuring it stays synchronized with the codebase, status files, progress logs, and the vision documented in `docs/vision.md and README.md`.
...
✅ **Always do:**
- Read `docs/vision.md and README.md` completely — it is the vision source of truth
...
- Document features that don't yet exist (aspiration belongs in `docs/vision.md and README.md`, not in guides)
...
**VISION ANALYSIS:**
- Read `docs/vision.md and README.md` completely — list every concept, workflow, and file format that should be documented
...
- Compare Vision (docs/vision.md and README.md) vs. Implementation vs. Documentation
...
- Base content on docs/vision.md and README.md vision + actual implementation

**ADR Updates:**
- Create ADRs for key design decisions documented in docs/vision.md and README.md
- Follow the standard ADR format: Status, Context, Decision, Consequences
- Number ADRs sequentially (`adr-001-`, `adr-002-`, etc.)
- Reference relevant docs/vision.md and README.md sections and source files
...
- [ ] ADRs reference relevant docs/vision.md and README.md sections
